...
This document provides an overview of a Security Information and Event Management (SIEM) home lab I created. In this lab, we will set up a honeypot, log the events, and display the results on a world map using Azure Sentinel.
